...
func List(ctx *gin.Context) {
	...
	r, err := global.GoodsSrvClient.GoodsList(context.WithValue(context.Background(), selfString("ginContext"), ctx), request)
	if err != nil {
...
func Detail(ctx *gin.Context) {
	...
	r, err := global.GoodsSrvClient.GetGoodsDetail(context.WithValue(context.Background(), selfString("ginContext"), ctx), &proto.GoodInfoRequest{
		Id: int32(i),
	})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
